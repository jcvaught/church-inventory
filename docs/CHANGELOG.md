...
- **Ship:** lint 0 errors (47 pre-existing warnings, none new) · build clean (verify-prod-bundle 0 jsxDEV) · `firebase deploy --only firestore:rules` (compiled + released clean) · frontend auto-deploys via Vercel. Both features additive; old data untouched.
