...
function AuthScreen({ authHook, initialMode = 'login', onBack }) {
  ...
  const phoneReminder = (
    <div style={{ display:"flex", alignItems:"flex-start", gap:10, background:B.tealPale, border:"1px solid "+B.teal, borderRadius:10, padding:"10px 14px", marginBottom:16, fontSize:13, color:B.teal, lineHeight:1.5 }}>
      <span aria-hidden="true" style={{ fontSize:16, lineHeight:1.4 }}>📱</span>
      <span><strong style={{ fontFamily:f1 }}>Want text reminders for your shifts?</strong> Once you're signed in, open <strong>Settings</strong> and add your phone number to get job reminders by text.</span>
    </div>
  );
