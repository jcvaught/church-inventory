...
export function Spinner() {
  return <div style={{ fontFamily:f2, display:"flex", alignItems:"center", justifyContent:"center", height:"100svh", background:B.cream, color:B.textLight, flexDirection:"column", gap:12 }}>
