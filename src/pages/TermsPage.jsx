  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <P><strong>Program name:</strong> ChurchOpsHub Job Reminders. <strong>Description:</strong> Automated SMS reminders sent the morning of each job shift to church volunteers who have opted in via the app. <strong>Sending number:</strong> +1 571-540-7100. <strong>Message frequency:</strong> Typically 1–5 messages per week; exact frequency depends on the number of job shifts you are signed up for. <strong>Message and data rates may apply.</strong> To get help, reply <strong>HELP</strong> to any message. To stop receiving messages, reply <strong>STOP</strong> to any message or disable SMS reminders in Settings → My Profile. Opt-out requests are honored immediately and will not affect your access to any other Service features. For support, contact <a href="mailto:churchopshub@gmail.com" style={{ color: B.teal }}>churchopshub@gmail.com</a>.</P>
