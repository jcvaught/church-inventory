  ...
  return (
    <>
      <SEO
        ...
        canonical="https://churchopshub.com/?terms"
      />
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <p style={{ fontFamily: f2, fontSize: 14, color: B.textLight, margin: '0 0 40px' }}>Last updated: March 14, 2026</p>
        ...
        <H3>7. SMS Communications</H3>
        <P><strong>Program name:</strong> ChurchOpsHub Job Reminders. <strong>Description:</strong> Automated SMS reminders sent the morning of each job shift to church volunteers who have opted in. <strong>Message frequency:</strong> One message per job shift you are signed up for; frequency varies by your job schedule. <strong>Message and data rates may apply.</strong> To get help, reply <strong>HELP</strong> to any message. To stop receiving messages, reply <strong>STOP</strong> to any message or disable SMS reminders in Settings → My Profile. For support, contact <a href="mailto:churchopshub@gmail.com" style={{ color: B.teal }}>churchopshub@gmail.com</a>.</P>
        ...
        <H3>16. Governing Law & Disputes</H3>
