...
function H3({ children }) {
  return <h3 style={{ fontFamily: f1, color: B.navy, marginTop: 28, marginBottom: 6, fontSize: 16, fontWeight: 700 }}>{children}</h3>;
}
  ...
  return (
    <>
      <SEO
        ...
        canonical="https://churchopshub.com/?privacy"
      />
      ...
      <div style={{ background: B.navy, padding: '14px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <a href="/" style={{ fontFamily: f1, fontSize: 13, color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>← Back to App</a>
      </div>

      {/* Content */}
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px 80px' }}>
        <h1 style={{ fontFamily: f1, fontSize: 30, fontWeight: 800, color: B.navy, margin: '0 0 4px' }}>Privacy Policy</h1>
        <p style={{ fontFamily: f2, fontSize: 14, color: B.textLight, margin: '0 0 40px' }}>Last updated: April 26, 2026</p>
        ...
        <P>We use your information to: provide and operate the Service; authenticate your identity and maintain your session; send transactional emails (account confirmation, password reset, reservation notifications); send SMS reminders to users who have explicitly opted in; diagnose errors and improve reliability; communicate with you about your account or changes to the Service; and comply with legal obligations. We do not use your data for advertising, and we do not sell or rent your information to third parties.</P>

        <H3>4. Data Ownership & Isolation</H3>
        ...
        <ul style={{ paddingLeft: 20, margin: '8px 0 14px', fontFamily: f2, fontSize: 15, color: B.textMid, lineHeight: 1.7 }}>
          ...
          <li style={{ marginBottom: 8 }}><strong>SendGrid (Twilio)</strong> — email notifications for reservation decisions, ticket assignments, job announcements, and task reminders. Only used if your church administrator enables this feature. <a href="https://www.twilio.com/en-us/legal/privacy" target="_blank" rel="noopener noreferrer" style={{ color: B.teal }}>Twilio Privacy</a></li>
          <li style={{ marginBottom: 8 }}><strong>Twilio Programmable Messaging</strong> — optional SMS reminders sent to users who have explicitly opted in via Settings. Phone numbers are stored in your profile and transmitted to Twilio solely to deliver opted-in messages. Users may opt out at any time by replying STOP or disabling SMS in Settings. <a href="https://www.twilio.com/en-us/legal/privacy" target="_blank" rel="noopener noreferrer" style={{ color: B.teal }}>Twilio Privacy</a></li>
        ...
        <H3>6. SMS Communications</H3>
        <P>If you provide a phone number and enable SMS reminders, you consent to receive automated text messages from ChurchOpsHub (sent from +1 571-540-7100) regarding jobs you are signed up for. Message frequency depends on your job schedule. Message and data rates may apply. To opt out, reply STOP to any message or disable SMS reminders in Settings → My Profile. For help, reply HELP. Opting out will not affect your access to any other features of the Service.</P>

        <H3>7. Data Storage & Security</H3>
        ...
        <H3>10. California Residents (CCPA)</H3>
        ...
        <H3>12. Cookies & Local Storage</H3>
