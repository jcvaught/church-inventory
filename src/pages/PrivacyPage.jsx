  ...
  return (
    <>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <P>If you provide a phone number and enable SMS reminders, you consent to receive automated text messages from ChurchOpsHub (sent from +1 571-540-7100) regarding jobs you are signed up for. Message frequency varies; typically 1–5 messages per week depending on your job schedule. <strong>Message and data rates may apply.</strong> To opt out, reply <strong>STOP</strong> to any message or disable SMS reminders in Settings → My Profile. For help, reply <strong>HELP</strong>. Opting out will not affect your access to any other features of the Service. Phone numbers are used solely for this SMS reminder program; we do not share, rent, or sell them. Full program disclosure (sample messages, frequency, consent flow) is at <a href="/sms-program" style={{ color: B.teal }}>churchopshub.com/sms-program</a>.</P>
