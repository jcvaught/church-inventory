...
└── package.json               ← Node 22, firebase-functions v7, firebase-admin v12, stripe v14, @sentry/node (server-side error capture, same DSN as browser; defaults catch process uncaughtException + unhandledRejection)
```
