...
│   ├── ItemsPage.jsx           ← Mounted inside InventoryPage (was the `inventory` tab pre-2026-06-23)
│   ├── SuppliesPage.jsx        ← Mounted inside InventoryPage (was the `supplies` tab)
│   ├── ReservationsPage.jsx    ← Mounted by HubsPage as the Reservations Hub (was the `reservations` tab)
│   ├── ActivityLogPage.jsx
