...
│       ├── PeopleAccessPage.jsx    ← People Access Hub: background checks, key assignments, certifications, custom compliance milestones; bulk entry modal; link/unlink to user accounts. Views: People · **Readiness** (serving-readiness cross-tab by requirement [clear/renewing/expired/no-record across active people, "Required for shifts" badge from upcoming jobs' requiredAccessTypes] + 90-day expiry timeline; mirrors server isAccessEligible) · Requirements · Timesheet
